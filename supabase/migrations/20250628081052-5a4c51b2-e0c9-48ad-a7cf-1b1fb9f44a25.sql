...
-- Create saved audits table for audit management
...
DROP POLICY IF EXISTS "Users can view own audits" ON public.saved_audits;
DROP POLICY IF EXISTS "Users can create own audits" ON public.saved_audits;
DROP POLICY IF EXISTS "Users can update own audits" ON public.saved_audits;
DROP POLICY IF EXISTS "Users can delete own audits" ON public.saved_audits;
...
DROP POLICY IF EXISTS "Users can view own templates or public ones" ON public.audit_templates;
DROP POLICY IF EXISTS "Users can create own templates" ON public.audit_templates;
DROP POLICY IF EXISTS "Users can update own templates" ON public.audit_templates;
DROP POLICY IF EXISTS "Users can delete own templates" ON public.audit_templates;
...
DROP POLICY IF EXISTS "Users can view own scheduled audits" ON public.scheduled_audits;
DROP POLICY IF EXISTS "Users can create own scheduled audits" ON public.scheduled_audits;
DROP POLICY IF EXISTS "Users can update own scheduled audits" ON public.scheduled_audits;
DROP POLICY IF EXISTS "Users can delete own scheduled audits" ON public.scheduled_audits;
...
-- Create trigger for new user (drop first to avoid conflicts)
...
-- Apply updated_at triggers to all tables (drop first to avoid conflicts)
