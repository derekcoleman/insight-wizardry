                ...
                <div className="flex items-center space-x-4">
                  <SidebarTrigger>
                    <Button 
                      variant="outline" 
                      size="icon"
                      className="h-10 w-10 bg-white/10 text-white border-white hover:bg-white/20 hover:text-white fixed md:static right-4 top-3 z-50 shadow-lg md:shadow-none"
                    >
