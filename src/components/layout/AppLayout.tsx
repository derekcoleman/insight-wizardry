                ...
                <div className="flex items-center">
                  <SidebarTrigger>
                    <Button 
                      variant="outline" 
                      size="icon"
                      className="h-10 w-10 bg-white text-[#221F26] border-white/20 hover:bg-white/90 hover:text-[#221F26] fixed md:static left-4 top-3 z-50 shadow-lg md:shadow-none"
                    >
